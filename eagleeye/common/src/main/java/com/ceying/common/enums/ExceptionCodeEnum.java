...
public enum ExceptionCodeEnum implements BaseEnum<ExceptionCodeEnum, String> {
    ...
    SYS0066("SYS0066","预警对象：{0}，SQL语句配置不正确，语句中如果有UNION，查询条件替换必需使用@WHERE_REP@标签"),
    SYS0067("SYS0067","预警规则：{0}，消息模板为空，请配置消息模板"),
    SYS0068("SYS0068","任务正在运行中，请稍后再试"),
    SYS0069("SYS0069","该手机号已被使用"),
    //scyp-biz
    ...
    BIZ0054("BIZ0054","应付账款导入excel首列为空"),
    BIZ0055("BIZ0055","没有交易账户"),
    //scyp-common
