...
public class ConfigCenter {
    ...
    public void init() throws Exception {
        ...
        zkClient.setData().forPath("/dubbo/config/dubbo/dubbo.properties", ("dubbo.registry.address=zookeeper://127.0.0.1:2183\n" +
                "dubbo.metadata-report.address=zookeeper://127.0.0.1:2183").getBytes());
    }
