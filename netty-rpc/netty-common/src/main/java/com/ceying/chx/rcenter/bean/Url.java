...
import com.ceying.chx.rcenter.util.UrlUtil;
import com.ceying.chx.rcenter.client.RpcProtocol;
import com.ceying.chx.rcenter.util.UrlUtil;
...
import static com.ceying.chx.rcenter.client.RpcProtocol.PROTOBUFF;
...
public class Url {
    ...
    public Url(String url){
        this.url=url;
        decode();
    }public Url(String serviceName,String url){
