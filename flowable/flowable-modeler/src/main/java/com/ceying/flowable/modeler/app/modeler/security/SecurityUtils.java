 ...
 */
package com.ceying.flowable.modeler.app.modeler.security;
...
public final class SecurityUtils {
    ...
    public static UserLoginEntity getSysUserLoginDto(){
        ...
        UserLoginEntity userLoginDto = (UserLoginEntity)request.getSession().getAttribute(UserStatusConstant.USER_LOGIN_SESSION);
        return userLoginDto;
    }
