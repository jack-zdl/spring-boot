...
<%
    String dataUrl = "/gateway/modeler/flowable-modeler/workflow/history/process-instance/finished.do";
%>
...
<script type="text/javascript">
    ...
    var onRowDbClick = function(id, data){
        ...
        delete data.name;
        data.type = type;
        var url = "${pageContext.request.contextPath}/workflow/client/hist/doneTaskWindow.jsp";
