...
<%
    String url = "/gateway/modeler/flowable-modeler/workflow/history/process-instance/completed.do";
%>
...
<script type="text/javascript">
    ...
    var onRowDbClick = function(id, data){
        ...
        delete data.name;
        data.type = type;
        var url = "${pageContext.request.contextPath}/workflow/client/myprocess/finishedWindow.jsp";
