package com.ceying.chx.cpi.base.rm.supplieraccount.controller;
 ...
 */
@RestController
@RequestMapping("/cpi/base/supplieraccount")
public class SupplierAccountController {

    @Resource
    private SupplierAccountService supplierAccountServiceImpl;

    @ApiOperation(value = "供应商的API接口")
    @ResponseBody
    @RequestMapping(value = "/list",method = RequestMethod.POST)
    public RespJson selectListSupplierAccount(HttpServletRequest request) throws ParamException, RedisConnectException {
        Map<String,Object> params = getParams(request);
        RespJson respJson = supplierAccountServiceImpl.list(params);
        return respJson;
    }
    //获取参数并返回
