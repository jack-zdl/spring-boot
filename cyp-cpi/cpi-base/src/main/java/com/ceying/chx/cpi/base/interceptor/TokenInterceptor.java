...
import com.ceying.chx.cpi.base.constant.SysConstants;
...
/**
 * 功能说明: 调用api时，检查token<br>
 * 系统版本: 1.0 <br>
 * 开发人员: zhangdl <br>
 * 开发时间: 2017/11/13 21:51<br>
 * <br>
 */
...
public class TokenInterceptor extends HandlerInterceptorAdapter {
    ...
    public boolean preHandle(HttpServletRequest request,
        ...
        System.out.println("进入TokenInterceptor拦截器");
...
////            final UserDetails userDetails = JWT.unsign(token, UserDetails.class);
//            //解密token后的loginId与用户传来的loginId不一致，一般都是token过期
//            if(null != loginId && null != token ) {
////                if(loginId.equals(userDetails.getUsername())) {
////                    return true;
//////                }
////                else{
