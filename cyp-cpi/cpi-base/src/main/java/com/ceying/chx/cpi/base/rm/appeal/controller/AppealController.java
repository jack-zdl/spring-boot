package com.ceying.chx.cpi.base.rm.appeal.controller;
 ...
 */
@RestController
@RequestMapping("/cpi/base/appeal")
public class AppealController {

    @Resource
    private AppealService appealServiceImpl;

    @ApiOperation(value = "申诉的API接口")
    @ResponseBody
    @RequestMapping(value = "/list",method = RequestMethod.POST)
    public RespJson selectListAppeal(HttpServletRequest request) throws ParamException, RedisConnectException {
        Map<String,Object> params = getParams(request);
        RespJson respJson = appealServiceImpl.list(params);
        return respJson;
    }
    //获取参数并返回
