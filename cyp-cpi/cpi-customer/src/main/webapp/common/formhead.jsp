...
<html>
	...
	<head>
		...
		<link type="text/css" rel="stylesheet" href="${pageContext.request.contextPath}/CYUI/bootstrap/assets/css/datepicker.css" />
		<link type="text/css" rel="stylesheet" href="${pageContext.request.contextPath}/CYUI/bootstrap/assets/css/ace.css" />
		<link type="text/css" rel="stylesheet" href="${pageContext.request.contextPath}/CYUI/themes/default/css/add.css" />
    	...
    	<script type="text/javascript" src="${pageContext.request.contextPath}/CYUI/themes/default/js/add.js"></script>
